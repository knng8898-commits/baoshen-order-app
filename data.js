...
huannanClosures: [
  ...
  vendors: {
    "西北": {rule:"sunday",cutoff:"11:00",header:"vendor",footer:"謝謝",groups:[
      {title:"一般品項",items:[{name:"麻吉燒芝麻",unit:"包",weekday:1,holiday:1},{name:"麻吉燒花生",unit:"包",weekday:1,holiday:1},{name:"原味水晶餃",unit:"包",weekday:2,holiday:2},{name:"芋頭角",unit:"包",weekday:1,holiday:1},{name:"甜不辣",unit:"包",weekday:1,holiday:1}]},
      {title:"強強滾",outputTitle:"強強滾：",items:["蝦餃","燕餃","魚餃","翡翠蝦球","鼠來寶","A級球","北海刺","黃金魚蛋","跳跳蝦","魚板","魚卵卷","鑫鑫腸"].map(name=>({name,unit:"包",weekday:name==="魚餃"?2:1,holiday:name==="魚餃"?2:1}))}
    ]},
...
"總部": {
  ...
  groups: [{
    title: "總部品項",
    items: [
      { name: "大骨", unit: "桶", weekday: 2, holiday: 2 },
      { name: "醬油", unit: "桶", weekday: 5, holiday: 5 },
      { name: "高湯粉 全", unit: "箱", weekday: 1, holiday: 1 },
      { name: "高湯粉1/4", unit: "箱", weekday: 1, holiday: 1 },
      { name: "高湯粉1/2", unit: "箱", weekday: 1, holiday: 1 },
      { name: "養生包", unit: "包", weekday: 2, holiday: 2 },
      { name: "麻辣香粉", unit: "包", weekday: 1, holiday: 1 }
    ]
  }]
}  }
};
