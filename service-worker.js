const CACHE_NAME = "baoshen-order-v5-20260810";
const ASSETS = ["./","./index.html","./styles.css?v=4.0.0","./data.js?v=5.1.0","./app.js?v=5.1.0","./history-analytics.js?v=5.1.0","./vendor-rules.js?v=5.1.0","./manifest.json"];
